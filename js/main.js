import {CONFIG} from './config.js?v=1.0.2p3';
import {createInput} from './input.js?v=1.0.2p3';
import {createUI} from './ui.js?v=1.0.2p3';
import {Game} from './game.js?v=1.0.2p3';
...
window.addEventListener('quest-dialogue',e=>{
  ...
  dialoguePortrait.src=`assets/portraits/${portraitMap[e.detail.name]||'will.png'}?v=1.0.2p3`;
  dialoguePortrait.alt=e.detail.name;
  dialoguePortrait.onerror=()=>{dialoguePortrait.src='assets/portraits/will.png?v=1.0.2p3'};
