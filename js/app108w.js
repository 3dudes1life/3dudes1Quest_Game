...
window.addEventListener('error',e=>{
  console.error('3Dudes1Quest 1.0.8W:',e.error||e.message);
...
class Adventure{
  ...
  save(){return {version:'1.0.8W',player:{x:this.player.x,y:this.player.y},state:this.state,cards:this.cards.map(c=>c.taken),beacons:this.beacons.map(b=>b.on),enemies:this.enemies.map(e=>({alive:e.alive,hp:e.hp,signHp:e.signHp,signUp:e.signUp})),secrets:this.secretSites.map(s=>s.found),boss:{hp:this.boss.hp,alive:this.boss.alive,phase:this.boss.phase},cityHallDamage:this.cityHallDamage,savedAt:new Date().toISOString()}}
...
const SAVE='3dudes1quest-save-108w';
const LEGACY_SAVES=['3dudes1quest-save-108v','3dudes1quest-save-108u','3dudes1quest-save-108t','3dudes1quest-save-108s','3dudes1quest-save-108r','3dudes1quest-save-108q','3dudes1quest-save-108p','3dudes1quest-save-108o','3dudes1quest-save-108n','3dudes1quest-save-108m','3dudes1quest-save-108l','3dudes1quest-save-108k','3dudes1quest-save-108j','3dudes1quest-save-108i','3dudes1quest-save-108h','3dudes1quest-save-108g'];
function readSave(){
  try{
