...
window.addEventListener('error',e=>{
  console.error('3Dudes1Quest 1.0.8G:',e.error||e.message);
...
class Adventure{
  ...
  save(){return {version:'1.0.8G',player:{x:this.player.x,y:this.player.y},state:this.state,cards:this.cards.map(c=>c.taken),beacons:this.beacons.map(b=>b.on),enemies:this.enemies.map(e=>e.alive),boss:{hp:this.boss.hp,alive:this.boss.alive,phase:this.boss.phase},savedAt:new Date().toISOString()}}
...
const SAVE='3dudes1quest-save-108g';
