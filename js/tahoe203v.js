...
window.__TAHOE_RELEASE__={version:"2.0.3v",name:"First Playable",publicDevShortcuts:false,features:["five-heart forgiving mode","coyote-time jumps","jump input buffering","variable jump gravity","wider platform landings","forgiving beetle stomps","play instructions","cinematic overlook ending"]};
})();