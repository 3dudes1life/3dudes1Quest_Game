...
const WORLD_W = 4600;
const FLOOR = 570;
const SAVE_KEY = "3dudes1quest_tahoe_v206";
const RELEASE = "2.0.6";
...
window.__TAHOE_RELEASE__={version:"2.0.6",name:"Tahoe Playable",publicDevShortcuts:false,features:["Level One control deck","single-path pointer input","reliable keyboard movement","jump-stomp combat","rainbow power blast","X and F attack keys","attack cooldown","clear shallow water","underwater stones","animated shoreline","varied Tahoe pines","saved checkpoint progress"]};
})();