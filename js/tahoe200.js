...
const dialogue = [
  ["Will","We made it...","assets/portraits/will.png"],
  ["Daniel","Tahoe. Our home away from home.","assets/portraits/daniel.png"],
  ["Caleb","Something feels different. Let's start at the lake and follow the trail.","assets/portraits/caleb.png"]
];
...
function nextDialogue() {
  ...
  if (state.dialogueIndex>=dialogue.length) {
    ...
    setObjective("Reach the first overlook","Follow the shoreline and climb toward the trailhead.");
    return;
  }
  showDialogueLine();
}
...
function finish() {
  ...
  state.complete=true;
  state.player.vx=0;
  setObjective("Foundation preview complete","The Pine Beetle waits beyond the trailhead.");
  setTimeout(()=>ui.trailheadCard.classList.remove("hidden"),400);
}
...
window.__TAHOE_RELEASE__={version:"2.0.0",name:"Lake Tahoe Foundation",features:["standalone preview","animated lake","parallax mountains","pine forest","granite climbing","character switching","Rigsby companion","Tahoe Memory","trailhead completion"]};
})();